...
EXPECTED_COLUMN_ALTERATIONS = {
    ...
    "domain_relevance_score": "ALTER TABLE market_signals ADD COLUMN IF NOT EXISTS domain_relevance_score DOUBLE PRECISION NOT NULL DEFAULT 0.0",
...
EXPECTED_STARTUP_OPPORTUNITY_ALTERATIONS = {
    ...
    "domain_relevance_score": "ALTER TABLE startup_opportunities ADD COLUMN IF NOT EXISTS domain_relevance_score DOUBLE PRECISION NOT NULL DEFAULT 0.0",
